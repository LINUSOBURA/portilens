                ...
                <div className="py-16">
                    <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                        <div className="w-full p-8 lg:w-1/2">
                            <h2 className="text-2xl font-semibold text-gray-700 text-center">Portilens</h2>
                            <p className="text-xl text-gray-600 text-center">Let's get started!</p>
                            ...
                            <div className="mt-4 flex items-center justify-between">
                                ...
                                <a href="/auth/login" className="text-xs text-gray-500 uppercase">or Login</a>
                                <span className="border-b w-1/5 md:w-1/4"></span>
                            </div>
                        </div>
                        <div className="hidden lg:block lg:w-1/2 bg-cover scale-x-[-1]"
